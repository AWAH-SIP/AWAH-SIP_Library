export PJDIR := /Users/andy/Dropbox/ElektronikundSoft/Projects/AWAH_SIP/AWAH_test/awah-sip-testapp/lib/pjsip/mac_x86-64/pjproject-2.10_jitter_aac
...
export CC_NAME := gcc
export TARGET_ARCH := 
export TARGET_NAME := x86_64-apple-darwin19.6.0
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lopus -lm -lpthread  -framework CoreAudio -framework CoreServices -framework AudioUnit -framework AudioToolbox -framework Foundation -framework AppKit -framework AVFoundation -framework CoreGraphics -framework QuartzCore -framework CoreVideo -framework CoreMedia -framework VideoToolbox  
